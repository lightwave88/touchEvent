...
//
// 主要在計算
// e.touches[0].pageX(水平)
// e.touches[0].pageY(垂直)
//
////////////////////////////////////////////////////////////////////////////////
//
// event =>(touchstart,touchmove,touchend)
// 有(touchstart)就一定有(touchend)
// 即使中間發生(resize or oritation)
...
(function($, global) {
    ...
    $.fn.touchwipeEvent = function(option) {
    ...
    /* ====================================================================== */
    // api
    $.touchwipeEvent = function(elem, config) {
        var touchEvent;
